 ...
 * @author MUTAI
 */
public class SentFailedFiles extends javax.swing.JFrame {
GridBagLayout grid= new GridBagLayout();
SentFailed ns= new SentFailed();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SentFailedFiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SentFailedFiles().setVisible(true);
            }
        });
    }
