 ...
 * @author MUTAI
 */
public class EncryptedFiles extends javax.swing.JFrame {
GridBagLayout grid= new GridBagLayout();
Encrypted ns= new Encrypted();
...
void Name(String username){
    ...
    private void initComponents() {
        ...
        jNotifLayout.setHorizontalGroup(
            ...
            .addGroup(jNotifLayout.createSequentialGroup()
                .addGap(229, 229, 229)
                .addComponent(usern, javax.swing.GroupLayout.PREFERRED_SIZE, 51, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EncryptedFiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EncryptedFiles().setVisible(true);
            }
        });
    }
