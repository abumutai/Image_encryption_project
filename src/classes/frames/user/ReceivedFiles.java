 ...
 * @author MUTAI
 */
public class ReceivedFiles extends javax.swing.JFrame {
GridBagLayout grid= new GridBagLayout();
Received ns= new Received();
...
void Name(String username){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ReceivedFiles.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ReceivedFiles().setVisible(true);
            }
        });
    }
